...
packages_needed <- c("ggplot2", "reshape2", "MASS", "gamlss.data", "distr")
r = getOption("repos")
...
9. [Real World Applications](#real-world-applications)
    ...
    b. [Deep Quantile Regression on Motorcycle Data](#deep-quantile-regression-on-motorcycle-data)
    c. [High-Dimensional Ridge and Lasso Regression on Colon Cancer Data](#high-dimensional-ridge-and-lasso-regression)
    d. [Mixture of Normal Distributions for Acidity Modeling](#mixture-of-normal-distributions-for-acidity-modeling)
    e. [Unstructured Data Examples](#unstructured-data-examples)
        i. [MNIST Pictures with Binarized Response](#mnist-zeros)
        ii. [MNIST Pictures with Multinomial Response](#mnist-multinomial)
        iii. [Sentiment Analysis using IMDB Reviews](#text-as-input)
